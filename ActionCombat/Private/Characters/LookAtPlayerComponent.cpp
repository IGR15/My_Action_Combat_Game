...
void ULookAtPlayerComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
	...
	FRotator LookAtRotation = UKismetMathLibrary::FindLookAtRotation(OwnerLocation, PlayerLocation);

	FRotator CurrentRotation{ OwnerRef->GetActorRotation() };

	FRotator NewRotation = UKismetMathLibrary::RInterpTo_Constant(CurrentRotation, LookAtRotation, DeltaTime, Speed);
